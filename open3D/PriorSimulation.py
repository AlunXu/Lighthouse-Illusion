...
for i in range(num_surfaces):
    ...
    coord_x = random.uniform(-view_width/2 + surface_size/2,
                             view_width/2 - surface_size/2)
    ...
    coord_y = random.uniform(-human_height, view_height -
                             human_height - surface_size/2)
    ...
    surface.translate([coord_x, coord_y, distance])
